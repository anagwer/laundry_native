<?php
	if(!$bool){
?>
<div class="modal fade" id="delete_pelanggan<?php echo $id_pelanggan?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				Apa Kamu yakin akan menghapus pelanggan?
			</div>
...
<?php
	...
	if(ISSET($_POST['delete'])){
		...
		$conn->query("delete from pelanggan where id_pelanggan='$id_pelanggan'") or die(mysql_error());
